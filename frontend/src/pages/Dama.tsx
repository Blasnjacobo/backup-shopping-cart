  ...
  return (
    <div>
      {loading ? (
        ...
        <div>
          <h1 style={{ marginLeft: '1rem', textAlign: 'center' }}>- Dama -</h1>
          <iframe
            width="97%"
            height="315"
          ...
          />
          <h2 style={{ marginLeft: '1rem' }}>Encuentra tu esencia única en cada gota</h2>
          <input
            type="text"
          ...
          <Row xs={1} md={2} lg={3} className="g-3">
            {(searchQuery ? filteredPerfumes : perfumes.filter(perfume => perfume.categoria === 'dama'))
            .map((perfume) => (
            <Col key={perfume._id}>
              <Perfume {...perfume} />
            </Col>
